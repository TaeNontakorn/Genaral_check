...
async def run_ocr_table_analysis(file_path: str, gemini_client: genai.Client) -> str:
    prompt = """
        คุณคือผู้เชี่ยวชาญด้านการสกัดข้อมูลและตรวจสอบความถูกต้องของข้อมูล (Data Extraction Expert)
        
        ### ภารกิจ: สกัดตารางข้อมูลทั้งหมดที่พบในเอกสาร (Extract All Data Tables)
        จากเอกสารที่ได้รับ:
        1. ให้ค้นหาและสกัด **ทุกตารางข้อมูล (All Structured Data Tables)** ที่ปรากฏอยู่ในเอกสาร โดยไม่มีการจำกัดกลุ่มคำหรือหัวข้อหัวคอลัมน์ใดๆ
        2. **ดึงคอลัมน์ทั้งหมดของทุกตารางมาอย่างครบถ้วน**: เมื่อพบตารางข้อมูลแล้ว ให้สกัดทุกคอลัมน์และทุกแถวในตารางนั้นออกมาอย่างสมบูรณ์ ห้ามลบหรือตัดคอลัมน์ใดคอลัมน์หนึ่งทิ้ง เพื่อให้ผู้ใช้สามารถเลือกใช้หัวข้อคอลัมน์ได้อย่างอิสระในขั้นตอนถัดไป
        3. **คัดกรองเฉพาะตารางที่เป็นตารางข้อมูลจริง**: ละเว้นตารางจัดโครงสร้างเลย์เอาต์ (Layout tables), ตารางกล่องลงชื่อ/ลายเซ็นท้ายเอกสาร (Signature blocks), หรือตารางข้อมูลรายละเอียดหัวกระดาษ/ท้ายกระดาษ (Header/Footer layout)
        4. แปลงตารางที่สกัดได้ทั้งหมดให้อยู่ในรูปแบบ Markdown Table ที่สมบูรณ์ โดยจัดเรียงลำดับตารางตามตำแหน่งที่ปรากฏในเอกสารจากหน้าแรกไปจนถึงหน้าสุดท้าย
        5. **ความถูกต้องของข้อมูล**: ห้ามสรุปข้อมูล ห้ามเปลี่ยนแปลง หรือแก้ไขข้อมูลตัวเลขใดๆ ทั้งสิ้น ต้องถูกต้องและตรงตามต้นฉบับ 100%

        ### รูปแบบการรายงานผล:
        - **ตารางที่สกัดได้**: [แสดง Markdown Table ทั้งหมดที่สกัดมา แยกตามลำดับตาราง]
        """
